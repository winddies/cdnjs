...
exports.default = {
  print: function print(params, printFrame) {
    ...
    if (params.header) {
      htmlData += (0, _functions.isRawHTML)(params.header) ? params.header : '<h1 style="' + params.headerStyle + '">' + params.header + '</h1>';
    }
...
exports.default = {
  print: function print(params, printFrame) {
    // Store html data
    params.htmlData = (0, _functions.addWrapper)(params.printable, params);
