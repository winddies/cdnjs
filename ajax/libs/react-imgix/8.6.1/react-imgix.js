...
function buildSrc(_ref) {
  ...
  if (disableSrcSet) {
    ...
    if (fixedSize || type === "source") {
      var dpr1 = (0, _constructUrl.default)(rawSrc, _objectSpread({}, disableQualityByDPR || {
        q: _common.CONSTANTS.q_dpr1
      }, srcOptions, {
        dpr: 1
      }));
      var dpr2 = (0, _constructUrl.default)(rawSrc, _objectSpread({}, disableQualityByDPR || {
        q: _common.CONSTANTS.q_dpr2
      }, srcOptions, {
        dpr: 2
      }));
      var dpr3 = (0, _constructUrl.default)(rawSrc, _objectSpread({}, disableQualityByDPR || {
        q: _common.CONSTANTS.q_dpr3
      }, srcOptions, {
        dpr: 3
      }));
      var dpr4 = (0, _constructUrl.default)(rawSrc, _objectSpread({}, disableQualityByDPR || {
        q: _common.CONSTANTS.q_dpr4
      }, srcOptions, {
        dpr: 4
      }));
      var dpr5 = (0, _constructUrl.default)(rawSrc, _objectSpread({}, disableQualityByDPR || {
        q: _common.CONSTANTS.q_dpr5
      }, srcOptions, {
        dpr: 5
      }));
      ...
      var buildSrcSetPair = function buildSrcSetPair(targetWidth) {
        ...
        var url = (0, _constructUrl.default)(rawSrc, urlParams);
