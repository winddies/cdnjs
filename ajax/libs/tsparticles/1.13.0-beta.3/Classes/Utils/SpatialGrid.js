...
var SpatialGrid = (function () {
    ...
    SpatialGrid.prototype.queryRadius = function (position, radius) {
        ...
        var out = [];
        for (var _i = 0, _a = items.filter(function (t) { return t !== undefined; }); _i < _a.length; _i++) {
            var item = _a[_i];
    ...
    SpatialGrid.prototype.select = function (start, end) {
        ...
        for (var x = start.x; x <= end.x; x++) {
            ...
            for (var y = start.y; y <= end.y; y++) {
                ...
                for (var _i = 0, _a = this.grid[x][y].filter(function (t) { return t !== undefined; }); _i < _a.length; _i++) {
                    var item = _a[_i];
                    out.push(item);
                }
            }
