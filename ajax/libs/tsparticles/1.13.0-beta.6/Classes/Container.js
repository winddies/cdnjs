...
var Container = (function () {
    ...
    Container.prototype.init = function () {
        ...
        if (this.options.blackHoles instanceof Array) {
            for (var _b = 0, _c = this.options.blackHoles; _b < _c.length; _b++) {
                var blackHoleOptions = _c[_b];
                var blackHole = new BlackHole_1.BlackHole(this, blackHoleOptions);
                this.blackHoles.push(blackHole);
            }
        }
        else {
            var blackHoleOptions = this.options.blackHoles;
            var blackHole = new BlackHole_1.BlackHole(this, blackHoleOptions);
            this.blackHoles.push(blackHole);
        }
