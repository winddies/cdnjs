...
export declare class CanvasUtils {
    ...
    static drawBlackHole(context: CanvasRenderingContext2D, blackHole: BlackHole): void;
    ...
    static gradient(context: CanvasRenderingContext2D, p1: IParticle, p2: IParticle, midColor: IRgb, opacity: number): CanvasGradient | undefined;
