        ...
        if (this.canPush) {
            ...
            switch (options.interactivity.events.onClick.mode) {
                ...
                case ClickMode_1.ClickMode.repulse:
                    ...
                    break;
                case ClickMode_1.ClickMode.blackHole:
                    var blackHolesModeOptions = void 0;
                    var modeBlackHoles = options.interactivity.modes.blackHoles;
                    if (modeBlackHoles instanceof Array) {
                        if (modeBlackHoles.length > 0) {
                            blackHolesModeOptions = Utils_1.Utils.itemFromArray(modeBlackHoles);
                        }
                    }
                    else {
                        blackHolesModeOptions = modeBlackHoles;
                    }
                    var blackHolesOptions = blackHolesModeOptions !== null && blackHolesModeOptions !== void 0 ? blackHolesModeOptions : (options.blackHoles instanceof Array ?
                        Utils_1.Utils.itemFromArray(options.blackHoles) :
                        options.blackHoles);
                    var bhPosition = container.interactivity.mouse.clickPosition;
                    var blackHole = new BlackHole_1.BlackHole(container, blackHolesOptions, bhPosition);
                ...
                case ClickMode_1.ClickMode.emitter:
                    ...
                    var emitter = new Emitter_1.Emitter(container, emitterOptions, ePosition);
