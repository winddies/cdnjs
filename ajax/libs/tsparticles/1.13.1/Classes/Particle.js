...
var Particle = (function () {
    function Particle(container, position, emitter) {
        ...
        if (((_c = (_b = (_a = emitter === null || emitter === void 0 ? void 0 : emitter.emitterOptions) === null || _a === void 0 ? void 0 : _a.particles) === null || _b === void 0 ? void 0 : _b.shape) === null || _c === void 0 ? void 0 : _c.type) !== undefined) {
            ...
            var shapeOptions = emitter.emitterOptions.particles.shape.options;
            if (shapeOptions !== undefined) {
                var shapeData = shapeOptions[this.shape];
            ...
            particlesOptions.load((_h = this.shapeData) === null || _h === void 0 ? void 0 : _h.particles);
            ...
            if (shapeData) {
                this.shapeData = shapeData instanceof Array ? Utils_1.Utils.itemFromArray(shapeData) : shapeData;
                this.fill = (_j = this.shapeData.fill) !== null && _j !== void 0 ? _j : this.fill;
                this.close = (_k = this.shapeData.close) !== null && _k !== void 0 ? _k : this.close;
            }
